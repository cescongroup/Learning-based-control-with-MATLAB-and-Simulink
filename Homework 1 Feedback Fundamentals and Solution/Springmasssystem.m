function [tend,A,omega,range,y]=springmassSolver(A,omega,m1,m2,k1,k2,k3)
% Spring mass system
c = 10; % damping
...
ylabel('Position [m]')
 grid on
title({sprintf('Input and Outputs over entire period'); ...
    sprintf(' A=%s and omega = %s',num2str(A),num2str(omega)); ...
    sprintf('m1=%s, m2=%s, k1=%s, k2=%s, k3=%s',num2str(m1),num2str(m2),num2str(k1),num2str(k2),num2str(k3))})
