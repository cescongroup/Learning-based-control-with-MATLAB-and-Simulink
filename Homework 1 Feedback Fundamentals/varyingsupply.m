function varyingsupply(A_sup,omega_sup)
...
c = br*(1+A_sup*sin(omega_sup*k/(4*nperiods))); % varying food supply 
...
hold on;
grid on;
 title({'Varying Food Supply';sprintf(' A = %s [m] and \\omega = %s [rad]',num2str(A_sup),num2str(omega_sup))})
